...
if (empty($pickup_destination) || empty($pax) || empty($pickup_time) || empty($contact) || empty($service)) {
...
if ($conn->query($sqlBooking) === TRUE) {
    ...
    <body>
        <div class="box">
            ...
            <p><strong>Pickup Destination:</strong> <?php echo $pickup_destination; ?></p>
            <p><strong>Number of Pax:</strong> <?php echo $pax; ?></p>
